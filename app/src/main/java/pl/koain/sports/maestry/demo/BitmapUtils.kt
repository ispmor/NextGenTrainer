package pl.koain.sports.maestry.demo
...
object BitmapUtils {
    ...
    fun getBitmap(data: ByteBuffer, metadata: FrameMetadata?): Bitmap? {
        ...
        try {
            ...
            metadata?.let {
                YuvImage(
                        imageInBuffer, ImageFormat.NV21, it.width, metadata.height, null)
            }?.compressToJpeg(Rect(0, 0, metadata.width, metadata.height), 80, stream)
